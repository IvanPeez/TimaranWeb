...
const GalleryGrid = ({ items = [], gradientColor = 'black', }) => {
  ...
  return (
    <div ref={gridRef} className="h-full w-full overflow-hidden">
      <section
        className="w-full h-[35rem] overflow-hidden relative flex items-center justify-center"
        style={{
          background: `black`,
        }}
      >
        {/* Noise overlay */}
        <div
          className="bg-gradient-to-t from-transparent from-55% to-white absolute inset-0 pointer-events-none z-[4]"
        ></div>
        <div
